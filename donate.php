        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">AMG Internatinal Conference Centre, ELdama Ravine Kenya</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 28th Jan, 2024</span>
                  <span><i class="fa fa-archive"></i> <a href="#">AMG Kenya</a>, <a href="#">Eldama Ravine</a></span>
                </span>
                <div class="spacer-20"></div>
                <div class="row">
                	<div class="col-md-7">
              			<img src="images/cause-img.JPG" class="img-responsive">
                    </div>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                            ...
                            <div class="progress">
                              <div class="progress-bar progress-bar-success" data-appear-progress-animation="11%" data-appear-animation-delay="200"></div>
                            </div>
                          </li>
                      	  <li class="list-group-item"> <span class="badge">ksh 1,000,000</span> Amount Needed </li>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call 254-724-556-468</p>
                  </div>
                </div>
              </div>
            </div>
