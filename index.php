...
<!-- End Site Header --> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      <li class=" parallax" style="background-image:url(images/slid.jpg);"></li>
      <li class="parallax" style="background-image:url(images/slide.JPG);"></li>
    </ul>
  </div>
  <!-- End Hero Slider --> 
  <!-- Start Notice Bar -->
          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome to AMG International Kenya</h3>
              </header>
			  <?php
